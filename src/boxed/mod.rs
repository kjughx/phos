...
use core::{
    marker::Unsize,
    ops::{CoerceUnsized, Deref, DerefMut, DerefPure, DispatchFromDyn, Index, IndexMut},
    ptr::Unique,
};
...
impl<T: ?Sized + Unsize<U>, U: ?Sized> DispatchFromDyn<Dyn<U>> for Dyn<T> {}
unsafe impl<T: ?Sized> DerefPure for Dyn<T> {}
